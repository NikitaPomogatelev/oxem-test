...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _modules_hero_slider__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/hero-slider */ "./src/js/modules/hero-slider.js");
/* harmony import */ var _modules_range_slider__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/range-slider */ "./src/js/modules/range-slider.js");
/* harmony import */ var _modules_burger_menu__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/burger-menu */ "./src/js/modules/burger-menu.js");
/* harmony import */ var _modules_maskValidate__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/maskValidate */ "./src/js/modules/maskValidate.js");
/* harmony import */ var _modules_openForm__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/openForm */ "./src/js/modules/openForm.js");
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_maskValidate__WEBPACK_IMPORTED_MODULE_3__["default"])();
  Object(_modules_openForm__WEBPACK_IMPORTED_MODULE_4__["default"])();
});
...
var heroSlider = function heroSlider() {
  ...
  var circle = document.querySelector('.hero-ring__circle');
...
/***/ "./src/js/modules/maskValidate.js":
/*!****************************************!*\
  !*** ./src/js/modules/maskValidate.js ***!
  \****************************************/
/*! exports provided: default */
...
/* harmony import */ var inputmask__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! inputmask */ "./node_modules/inputmask/index.js");
/* harmony import */ var inputmask__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(inputmask__WEBPACK_IMPORTED_MODULE_8__);
...
var maskValidate = function maskValidate() {
  var inputs = document.querySelectorAll('input[type="tel"]');
  var onlineForm = document.querySelector('.online__form');
  var calcForm = document.querySelector('.calc__form');
  var calcInputs = calcForm.querySelectorAll('.calc-input');
  var onlineInputs = onlineForm.querySelectorAll('input');
  var calcArray = [];
  var im = new inputmask__WEBPACK_IMPORTED_MODULE_8___default.a('+7 (999) 999-99-99');
  im.mask(inputs);
  ...
  var sendValidForm = function sendValidForm() {
    // Карта валидации
    var patterns = {
      notEmpty: /.+/
    };
    onlineForm.addEventListener('submit', function (e) {
      e.preventDefault();
      var err = false; // Валидация полей

      onlineInputs.forEach(function (input) {
        input.value = input.value.trim();
        var pattern = patterns[input.dataset.valid];
    ...
    onlineForm.addEventListener('focusin', function (e) {
      var target = e.target;
...
/* harmony default export */ __webpack_exports__["default"] = (maskValidate);

/***/ }),

/***/ "./src/js/modules/openForm.js":
/*!************************************!*\
  !*** ./src/js/modules/openForm.js ***!
  \************************************/
/*! exports provided: default */
...
var openForm = function openForm() {
  var $overlay = document.querySelector('.overlay');
  var btnRequest = document.querySelectorAll('.btn-request');
  var onlineForm = document.querySelector('.online');
  var onlineClose = document.querySelector('.online-close');
  btnRequest.forEach(function (btn) {
    btn.addEventListener('click', function () {
      onlineForm.classList.add('active');
      $overlay.classList.add('active');
    });
  });
  onlineClose.addEventListener('click', function () {
...
/* harmony import */ var accounting_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! accounting-js */ "./node_modules/accounting-js/dist/accounting.umd.js");
/* harmony import */ var accounting_js__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(accounting_js__WEBPACK_IMPORTED_MODULE_3__);
...
var rangeSlider = function rangeSlider() {
  var costSlider = document.querySelector('.calc__slider-cost');
  var paymentSlider = document.querySelector('.calc__slider-payment');
  var dateSlider = document.querySelector('.calc__slider-date');
  var inputCost = document.querySelector('.input-cost');
  var inputPayment = document.querySelector('.input-payment');
  var inputDate = document.querySelector('.input-date');
  var calcInputPercent = document.querySelector('.calc-input__percent');
  var inputPerMounth = document.querySelector('.input-per-mounth');
  var inputContract = document.querySelector('.input-contract');
  var arr = [null, null];
  nouislider__WEBPACK_IMPORTED_MODULE_4___default.a.create(costSlider, {
  ...
  nouislider__WEBPACK_IMPORTED_MODULE_4___default.a.create(paymentSlider, {
    start: [10, 60],
    connect: true,
    step: 1,
    range: {
  ...
  nouislider__WEBPACK_IMPORTED_MODULE_4___default.a.create(dateSlider, {
    start: [1, 60],
    connect: true,
    step: 1,
    range: {
  ...
  var formatRubles = function formatRubles(number) {
    return accounting_js__WEBPACK_IMPORTED_MODULE_3___default.a.formatNumber(number, {
      precision: 0,
      thousand: " ",
      decimal: " "
    });
  ...
  var setRangeSlider = function setRangeSlider(rangeSlider, value) {
    arr[1] = value;
    rangeSlider.noUiSlider.set(arr);
  };

  var calcCost = function calcCost() {
    var percent = +calcInputPercent.textContent.replace('%', '').trim(); // Первончальный взнос в цифрах
